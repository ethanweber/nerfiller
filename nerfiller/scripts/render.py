...
class RenderCameraPath(BaseRender):
    ...
    inference_near_plane: Optional[float] = None
    """Set the near plane if this is set."""
    ...
    def main(self) -> None:
        ...
        if self.inference_near_plane:
            # TODO: assert that inference_near_plane is an attribute of the collider
            pipeline.model.collider.inference_near_plane = self.inference_near_plane
