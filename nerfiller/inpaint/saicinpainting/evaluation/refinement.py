...
from nerfiller.inpaint.saicinpainting.evaluation.data import pad_tensor_to_modulo
from nerfiller.inpaint.saicinpainting.evaluation.utils import move_to_device
from nerfiller.inpaint.saicinpainting.training.modules.ffc import FFCResnetBlock
from nerfiller.inpaint.saicinpainting.training.modules.pix2pixhd import ResnetBlock
        ...
        if idd < len(gpu_ids) - 1:
            forward_rears.append(
                inpainter.generator.model[
                    first_resblock_ind + resblocks_per_gpu * (idd) : first_resblock_ind + resblocks_per_gpu * (idd + 1)
                ]
            )
        else:
